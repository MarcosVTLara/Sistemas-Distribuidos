...
import random
## BEM IMPORTANTE
## NÃO PODE COLOCAR TODOS OS PROCESSOS NOS SERVIÇOES DE NOMES. APENAS O LEADER!!!!!!!!!!!!!
@Pyro5.server.expose
class Processo1(object):
    ...
    def send_candidatura(self):
        #Criar 5 threads para enviar as 5 ao mesmo tempo
    ...
    def aux_heartbeat(self, processo):
        try:
            nameserver = Pyro5.api.locate_ns()
            server = Pyro5.api.Proxy(nameserver.lookup(processo))
    ...
    def send_heartbeat(self):
        # self.aux_heartbeat("processo1")
        self.aux_heartbeat("processo2")
        # self.aux_heartbeat("processo3")
        # self.aux_heartbeat("processo4")
